---
layout: page
title: "Open questions and validation register"
permalink: /reference/open-questions/
---

# Open questions and validation register

Known gaps in the guide's evidence base that require vendor confirmation, measurements, completed-build evidence, or functional testing before they can become prescriptive guidance.
