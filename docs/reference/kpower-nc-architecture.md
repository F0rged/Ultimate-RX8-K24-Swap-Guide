---
layout: page
title: "KPower / NC-derived architecture"
permalink: /reference/kpower-nc-architecture/
build_topics:
  - architecture
  - mounts
  - steering
...
# KPower / NC-derived architecture

Detailed compatibility, component, steering, drivetrain and packaging notes for the KPower NC-derived RX-8 architecture.
