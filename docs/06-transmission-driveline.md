...
Required architecture components include:

- K-to-RX-8 adapter plate
- alignment dowels / correct adapter hardware
- K-to-RX-8 flywheel
...
- input shaft condition
- shifter operation
- bellhousing cracks
- slave mounting threads
- rear/PPF mounting points
- fluid condition and magnetic debris

A used gearbox that already has synchronizer or bearing symptoms is not a cost-saving part.
...
- crank flange clean and burr-free
- adapter dowels fully seated
- adapter flush to block
- starter trial-fitted before clutch traps access
- pilot bearing correct orientation/depth
- flywheel runout checked if anything looks suspect
- clutch disc correct way around
- clutch alignment tool used
- pressure plate drawn down gradually in a star pattern

## 6.3 Slave cylinder

Current Collins options include a Mazda 6 / Mazdaspeed 6 clutch slave for RX-8 applications. Older independent builds had to fabricate around slave/adapter interference; that is precisely why current component revision and vendor instructions matter.

Before installing the engine permanently:

- bolt the slave on
- verify full physical clearance
- verify bleeder accessibility
- verify hose routing away from exhaust
- check release travel without over-stroking

## 6.4 PPF

The PPF is a structural driveline member. Do not:

- pry it into alignment and use bolts as clamps;
...
3. start fasteners by hand;
4. verify no gross fore/aft or vertical preload;
5. torque using Mazda service information for the exact chassis.
...
- verify no PPF/exhaust contact at full drivetrain movement;
- replace gear oil if service history is unknown.
...
Before plumbing/wiring, you should be able to:
