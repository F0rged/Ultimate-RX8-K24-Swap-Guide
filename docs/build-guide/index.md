...
This is the sequential, prescriptive path through the RX-8 K24 swap. Read it in order unless you are deliberately jumping back to verify a completed gate.

## Chapters

1. [Scope, assumptions and safety](00-scope-and-safety.html)
2. [Choose the architecture](01-architecture.html)
3. [Build the BOM and budget](02-bom-budget.html)
4. [Verify and prepare the JDM K24A](03-jdm-k24a-engine-prep.html)
...
10. [Electrical, ECU and S2 CAN](09-electrical-ecu-can-s2.html)
